...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.67.110"];
pub const RS_PUB_KEY: &str = "39iCJusN1Mh+H7OqXB8i10yeRlfG2ytJbtBN5y3CQhM=";
pub const RENDEZVOUS_PORT: i32 = 25656;
pub const RELAY_PORT: i32 = 25657;
pub const WS_RENDEZVOUS_PORT: i32 =25658;
pub const WS_RELAY_PORT: i32 = 25659;
